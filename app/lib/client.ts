...
export function Environment(name: string): BaseURL {
    return `https://${name}-keplerchat-ysa2.encr.app`
}
...
/**
 * Client is an API client for the keplerchat-ysa2 Encore application.
 */
...
export namespace chat {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.ChatAPIStream = this.ChatAPIStream.bind(this)
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if ( typeof globalThis === "object" && !("window" in globalThis) ) {
            this.headers["User-Agent"] = "keplerchat-ysa2-Generated-TS-Client (Encore/v1.46.20)";
        }
